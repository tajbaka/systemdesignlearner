...
export function NavbarMobile({
  ...
  return (
    <>
      ...
      <button
        onClick={toggleMenu}
        className={`fixed top-2 z-[60] flex h-10 w-10 items-center justify-center rounded-lg border shadow-md transition-all ${isMenuOpen ? "right-4" : "left-4"} ${buttonBgClass}`}
