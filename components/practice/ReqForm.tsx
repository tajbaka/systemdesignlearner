...
export const ReqForm = ({ value, locked, onChange, onContinue }: ReqFormProps) => {
      ...
      <section className="rounded-xl border border-zinc-200 bg-white p-4 shadow-sm dark:border-zinc-700 dark:bg-zinc-900">
        ...
        <div className="grid gap-3 sm:grid-cols-2">
          {FUNCTIONAL_TOGGLES.map((toggle) => (
            <label
              key={toggle.id}
              className={`flex min-h-[3.25rem] cursor-pointer items-start gap-3 rounded-lg border px-3 py-2 transition focus-within:ring-2 focus-within:ring-blue-500 ${
