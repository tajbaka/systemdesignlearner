    ...
    async (
      ...
      try {
        ...
        if (stepFeedback.lastContent === userContent && stepFeedback.cachedResult) {
          ...
          // Update the cached result with showSolution flag based on current attempt count
          const updatedResult = {
            ...stepFeedback.cachedResult,
            ui: {
              ...stepFeedback.cachedResult.ui,
              showSolution: newAttemptCount >= 3 && stepFeedback.cachedResult.ui.blocking,
            },
          };
        ...
        console.log(
          "[useIterativeFeedback] Result received - showSolution:",
          result.ui.showSolution,
          "attemptCount:",
          newAttemptCount,
          "blocking:",
          result.ui.blocking
