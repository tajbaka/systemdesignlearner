...
import { useSidepanel } from "../layouts/SidepanelLayout";
...
export function CommonLayout({
  ...
  const leftPanel = useSidepanel();
  const isMobile = useIsMobile();
  const showMobilePanelButton =
    isMobile && leftPanel && stepType && stepType !== STEPS.INTRO && stepType !== STEPS.SCORE;

  // Get current step data for title
                ...
                <div className="relative flex items-center justify-center pl-6 pr-16 md:pl-0 md:pr-0 pt-[18px] pb-[18px] md:pt-10 md:pb-0">
                  ...
                  {showMobilePanelButton && (
                    <div className="absolute right-6 md:right-0">
                      <button
                        type="button"
                        onClick={leftPanel.openMobilePanel}
