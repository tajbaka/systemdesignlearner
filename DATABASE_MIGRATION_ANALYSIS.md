...
*Designed to be versioned so we can update problems without breaking old sessions.*
...
*A user's attempt at a specific version of a scenario.*
...
*Granular tracking of each step in the flow.*
