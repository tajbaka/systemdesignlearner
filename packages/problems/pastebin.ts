        ...
        requirements: [
          {
            ...
            edges: [
              ...
              {
                id: "Service-1-Store-1-write",
                from: "Service-1",
                to: "Store-1",
                description:
                  "Service stores paste content in object storage for cost-effective blob storage",
                weight: 7,
                hints: [
                  {
                    id: "hint-service-s3-write",
                    title: "Service to Object Store (Write)",
              ...
              {
                id: "Service-1-Store-1-read",
                from: "Service-1",
                to: "Store-1",
                description:
                  "Service retrieves paste content from object storage when serving requests",
                weight: 5,
                hints: [
                  {
                    id: "hint-service-s3-read",
                    title: "Service to Object Store (Read)",
                    text: "Service retrieves paste content from object storage when serving requests",
                    href: "/learn/object-storage-cdn#read-path-viewing-a-paste",
                  },
                ],
              },
              {
                ...
                to: "Store-1",
                description:
                  "CDN caches popular pastes at edge locations and fetches from object store on cache misses",
                weight: 4,
                hints: [
                  {
                    id: "hint-cdn-s3",
                    title: "CDN to Object Store",
