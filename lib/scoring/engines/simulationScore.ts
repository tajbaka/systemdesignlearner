/**
 * Simulation Score Engine
 *
 * Calculates scores based on simulation results for the play/sandbox mode.
 * This is a simpler scoring system compared to the step-by-step practice scoring.
 */

import type { Scenario } from "@/lib/scenarios";
import type { PlacedNode } from "@/lib/types/domain";
