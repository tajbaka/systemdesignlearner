...
interface ProblemLastReminderEmailProps {
  problemTitle: string;
  problemSlug: string;
...
export const ProblemLastReminderEmail = ({
  problemTitle,
  problemSlug,
  problemDifficulty,
  recipientEmail,
      ...
      <Body style={main}>
        <Container style={container} className="container">
          ...
          <Text style={text} className="text">
            The <strong>{problemTitle}</strong>{" "}
            <span
              style={{
                ...inlineBadge,
            ...
            challenge we mentioned earlier is still available in your account, and this is the final
            reminder we&rsquo;ll send about it.
          </Text>

          <Text style={text} className="text">
            If you&rsquo;re curious, you can try it anytime here:
          </Text>
          ...
          <Text style={text} className="text">
            If not, no worries &mdash; we&rsquo;ll take the hint and let you get back to what you
            were doing.
          </Text>
...
export default ProblemLastReminderEmail;
