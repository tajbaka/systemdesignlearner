        ...
        <div className="prose prose-invert max-w-none space-y-8">
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              website owners. Cookies help us understand how you use our service and improve your
              experience.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed mb-3">
              These cookies are strictly necessary for the Service to function. Without these
              cookies, certain features would not work.
            </p>
            <div className="bg-card border border-border rounded-lg p-4 space-y-2">
              <div>
                <p className="font-semibold text-foreground">Authentication Cookies (Clerk)</p>
                <p className="text-sm text-muted-foreground">
                  Purpose: Manage user sessions and keep you logged in
                </p>
                <p className="text-sm text-muted-foreground">
                  Duration: Session or persistent (based on &quot;Remember me&quot;)
                </p>
            ...
            <div className="space-y-4">
              <div className="bg-card border border-border rounded-lg p-4 space-y-2">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Purpose: Track user behavior, feature usage, and performance metrics
                  </p>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Data Collected: Page views, clicks, session recordings, user properties
                  </p>
                </div>
              </div>
              ...
              <div className="bg-card border border-border rounded-lg p-4 space-y-2">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Data Collected: Performance metrics, page load times
                  </p>
                </div>
              </div>
            </div>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed mb-3">
              ...
              control these cookies. The third parties include:
            </p>
            <ul className="list-disc list-inside space-y-2 text-muted-foreground">
              <li>
                <strong className="text-foreground">Clerk:</strong> Authentication services -{" "}
                <a
              ...
              <li>
                <strong className="text-foreground">PostHog:</strong> Analytics platform -{" "}
                <a
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              We use PostHog to record user sessions (screen recordings of how you interact with our
              Service). These recordings help us identify usability issues and improve the user
              experience. Session recordings never capture sensitive form inputs like passwords or
              payment information. You can opt out of session recording by enabling &quot;Do Not
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed mb-3">
              Most web browsers allow you to manage cookie preferences through browser settings. You
              can:
            </p>
            <ul className="list-disc list-inside space-y-2 text-muted-foreground">
            ...
            <p className="text-muted-foreground leading-relaxed">
              We respect &quot;Do Not Track&quot; browser settings. When enabled, we will not track
              your session or record your interactions with PostHog.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2 text-muted-foreground mt-3">
              <li>
                <strong className="text-foreground">Session cookies:</strong> Deleted when you close
                your browser
              </li>
              <li>
                <strong className="text-foreground">Authentication cookies:</strong> Up to 30 days
                or until you log out
              </li>
              <li>
                <strong className="text-foreground">Analytics cookies:</strong> Up to 1 year
              </li>
              <li>
                <strong className="text-foreground">Preference cookies:</strong> Up to 1 year
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              regarding your personal data collected through cookies. Please see our{" "}
