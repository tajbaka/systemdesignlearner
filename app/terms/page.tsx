      ...
      <div className="mx-auto max-w-4xl px-4 py-12">
        ...
        <div className="prose prose-invert max-w-none space-y-8">
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              You may use the Service for lawful educational and professional development purposes
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              You retain ownership of any system designs, diagrams, or content you create using the
              Service (&quot;Your Content&quot;). By using the Service, you grant us a limited
              license to store, display, and process Your Content solely to provide the Service to
              you.
            </p>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              NON-INFRINGEMENT. WE DO NOT WARRANT THAT THE SERVICE WILL MEET YOUR REQUIREMENTS OR
              THAT IT WILL BE SUITABLE FOR ANY PARTICULAR PURPOSE.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              United States, without regard to its conflict of law provisions. Any legal action or
              proceeding arising under these Terms will be brought exclusively in the courts located
