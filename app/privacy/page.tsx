...
export const metadata: Metadata = {
  ...
  description: "Privacy Policy for System Design Sandbox - How we collect, use, and protect your data.",
};
        ...
        <div className="prose prose-invert max-w-none space-y-8">
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed mb-3">
              We use cookies and similar tracking technologies to track activity on our service. We use:
            </p>
            <ul className="list-disc list-inside space-y-2 text-muted-foreground">
              <li><strong className="text-foreground">Essential Cookies:</strong> Required for authentication and basic functionality</li>
              <li><strong className="text-foreground">Analytics Cookies:</strong> PostHog analytics to understand how you use our platform</li>
              <li><strong className="text-foreground">Performance Cookies:</strong> Vercel Analytics for performance monitoring</li>
            </ul>
            <p className="text-muted-foreground leading-relaxed mt-3">
              See our <Link href="/cookies" className="text-blue-400 hover:text-blue-300 underline">Cookie Policy</Link> for more details.
            </p>
          </section>
          ...
          <section>
            ...
            <h3 className="text-xl font-semibold mb-3 mt-6">9.1 Categories of Personal Information We Collect</h3>
            <ul className="list-disc list-inside space-y-2 text-muted-foreground">
              <li><strong className="text-foreground">Identifiers:</strong> Email address, IP address, device identifiers</li>
              <li><strong className="text-foreground">Internet Activity:</strong> Browsing history on our site, pages visited, interaction with our service</li>
              <li><strong className="text-foreground">Geolocation Data:</strong> Approximate location based on IP address</li>
              <li><strong className="text-foreground">Professional Information:</strong> System design practice data, session results, scores</li>
            </ul>

            <h3 className="text-xl font-semibold mb-3 mt-6">9.2 How We Use Personal Information</h3>
            <p className="text-muted-foreground leading-relaxed mb-3">
              We use the categories of personal information listed above for the following business purposes:
            </p>
            <ul className="list-disc list-inside space-y-2 text-muted-foreground">
            ...
            <ul className="list-disc list-inside space-y-2 text-muted-foreground">
              <li><strong className="text-foreground">Know:</strong> Request disclosure of the categories and specific pieces of personal information we collect, use, disclose, and sell</li>
              <li><strong className="text-foreground">Delete:</strong> Request deletion of your personal information</li>
              <li><strong className="text-foreground">Opt-Out:</strong> Opt out of the sale of personal information (Note: We do not sell personal information)</li>
              <li><strong className="text-foreground">Non-Discrimination:</strong> Not be discriminated against for exercising your CCPA rights</li>
            </ul>

            <h3 className="text-xl font-semibold mb-3 mt-6">9.4 We Do Not Sell Your Personal Information</h3>
            <p className="text-muted-foreground leading-relaxed">
              We do not sell, rent, or share your personal information with third parties for their direct marketing purposes. We do not sell personal information of minors under 16 years of age.
            </p>
