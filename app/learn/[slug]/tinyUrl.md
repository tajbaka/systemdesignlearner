...
- Nobody wants to wait 500ms for a redirect
- Target: under 10ms for the lookup
- This is the critical path that affects user experience

**High read traffic**

- Redirects happen way more often than URL creation
- Read-to-write ratio is often 100:1 or higher
- Need to scale reads independently from writes
- Example: 100 million redirects/day vs 1 million new URLs/day
...
- **Simple and fast:** Single database transaction, predictable performance
