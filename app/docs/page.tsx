    ...
    <div className="min-h-screen bg-gradient-to-br from-zinc-900 via-zinc-800 to-zinc-900">
      ...
      <div className="max-w-4xl mx-auto px-6 lg:px-8 py-16">
        ...
        <div className="text-center mb-16">
          <h1 className="text-4xl lg:text-5xl font-bold text-white mb-6">Documentation</h1>
        ...
        <section className="mb-16">
          <h2 className="text-3xl font-bold mb-8 text-emerald-400">Understanding Your Results</h2>

          <div className="space-y-8">
            <div className="bg-zinc-800/50 border border-zinc-700 rounded-xl p-6">
              <h3 className="text-xl font-semibold mb-4 text-emerald-300">Capacity (RPS)</h3>
            ...
            <div className="bg-zinc-800/50 border border-zinc-700 rounded-xl p-6">
              <h3 className="text-xl font-semibold mb-4 text-emerald-300">Latency (P95)</h3>
              <p className="text-zinc-300 mb-4">
            ...
            <div className="bg-zinc-800/50 border border-zinc-700 rounded-xl p-6">
              <h3 className="text-xl font-semibold mb-4 text-emerald-300">Outcome States</h3>
              <div className="grid md:grid-cols-4 gap-4 mb-4">
                <div className="text-center">
                  <div className="w-12 h-12 bg-emerald-500 rounded-full flex items-center justify-center mx-auto mb-2">
                    <span className="text-white font-bold">✓</span>
                  </div>
                  <div className="text-emerald-300 font-semibold">Pass</div>
                  <div className="text-sm text-zinc-400">Both metrics met</div>
                </div>
                <div className="text-center">
                  <div className="w-12 h-12 bg-amber-500 rounded-full flex items-center justify-center mx-auto mb-2">
                    <span className="text-white font-bold">~</span>
                  </div>
                  <div className="text-amber-300 font-semibold">Partial</div>
                  <div className="text-sm text-zinc-400">One metric met</div>
                </div>
                <div className="text-center">
                  <div className="w-12 h-12 bg-rose-500 rounded-full flex items-center justify-center mx-auto mb-2">
                    <span className="text-white font-bold">✗</span>
                  </div>
                  <div className="text-rose-300 font-semibold">Fail</div>
                  <div className="text-sm text-zinc-400">Neither met</div>
                </div>
                <div className="text-center">
                  <div className="w-12 h-12 bg-red-500 rounded-full flex items-center justify-center mx-auto mb-2">
                    <span className="text-white font-bold">⚡</span>
                  </div>
                  <div className="text-red-300 font-semibold">Chaos Fail</div>
                  <div className="text-sm text-zinc-400">Component crashed</div>
                </div>
              </div>
            </div>

            <div className="bg-zinc-800/50 border border-zinc-700 rounded-xl p-6">
              <h3 className="text-xl font-semibold mb-4 text-emerald-300">Hints System</h3>
              <p className="text-zinc-300 mb-4">
        ...
        <section className="mb-16">
          <h2 className="text-3xl font-bold mb-8 text-emerald-400">Essential Reading</h2>

          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-zinc-800/50 border border-zinc-700 rounded-xl p-6">
              <h3 className="text-lg font-semibold mb-3 text-white">📚 Fundamentals</h3>
            ...
            <div className="bg-zinc-800/50 border border-zinc-700 rounded-xl p-6">
              <h3 className="text-lg font-semibold mb-3 text-white">🏗️ Architecture Patterns</h3>
              <ul className="space-y-2 text-sm text-zinc-300">
                <li>
                  <a
            ...
            <div className="bg-zinc-800/50 border border-zinc-700 rounded-xl p-6">
              <h3 className="text-lg font-semibold mb-3 text-white">⚡ Performance & Scaling</h3>
              <ul className="space-y-2 text-sm text-zinc-300">
                <li>
                  <a
            ...
            <div className="bg-zinc-800/50 border border-zinc-700 rounded-xl p-6">
              <h3 className="text-lg font-semibold mb-3 text-white">🔧 Tools & Technologies</h3>
              <ul className="space-y-2 text-sm text-zinc-300">
                <li>
                  <a
        ...
        {/* Common Patterns */}
        <section className="mb-16">
          <h2 className="text-3xl font-bold mb-8 text-emerald-400">Common Design Patterns</h2>

          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-zinc-800/50 border border-zinc-700 rounded-xl p-6">
              <h3 className="text-xl font-semibold mb-3 text-white">Cache-Aside Pattern</h3>
            ...
            <div className="bg-zinc-800/50 border border-zinc-700 rounded-xl p-6">
              <h3 className="text-xl font-semibold mb-3 text-white">Circuit Breaker</h3>
              <p className="text-zinc-300 mb-3">
            ...
            <div className="bg-zinc-800/50 border border-zinc-700 rounded-xl p-6">
              <h3 className="text-xl font-semibold mb-3 text-white">Database Sharding</h3>
              <p className="text-zinc-300 mb-3">
            ...
            <div className="bg-zinc-800/50 border border-zinc-700 rounded-xl p-6">
              <h3 className="text-xl font-semibold mb-3 text-white">Event Sourcing</h3>
              <p className="text-zinc-300 mb-3">
