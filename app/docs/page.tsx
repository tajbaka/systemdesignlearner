    ...
    <div className="min-h-screen bg-zinc-900 text-white">
      ...
      <div className="max-w-4xl mx-auto px-6 lg:px-8 py-16">
        ...
        <div className="text-center mb-16">
          <h1 className="text-4xl lg:text-5xl font-bold mb-6">Documentation</h1>
        ...
        <section className="mb-16">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-zinc-800/50 border border-zinc-700 rounded-xl p-6">
              <h3 className="text-lg font-semibold mb-3">📚 Fundamentals</h3>
            ...
            <div className="bg-zinc-800/50 border border-zinc-700 rounded-xl p-6">
              <h3 className="text-lg font-semibold mb-3">⚡ Performance & Scaling</h3>
              <ul className="space-y-2 text-sm">
                <li>
                  <a
        ...
        <section className="mb-16">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-zinc-800/50 border border-zinc-700 rounded-xl p-6">
              <h3 className="text-xl font-semibold mb-3">Cache-Aside Pattern</h3>
            ...
            <div className="bg-zinc-800/50 border border-zinc-700 rounded-xl p-6">
              <h3 className="text-xl font-semibold mb-3">Circuit Breaker</h3>
              <p className="text-zinc-300 mb-3">
            ...
            <div className="bg-zinc-800/50 border border-zinc-700 rounded-xl p-6">
              <h3 className="text-xl font-semibold mb-3">Database Sharding</h3>
              <p className="text-zinc-300 mb-3">
